...
class Plugin2Info implements IContextInfo, IPlugin2Info {
	/**
	 ...
	 */
	public static Parcelable.Creator<Plugin2Info> CREATOR = new Parcelable.Creator<Plugin2Info>() {
		/**
		 ...
		 */
		public Plugin2Info createFromParcel(Parcel in) {
			return new Plugin2Info(in);
		}

		/**
		 * Create a new array of the Parcelable class.
		 */
		public Plugin2Info[] newArray(int size) {
			return new Plugin2Info[size];
		}
	};
	// Public static variable for our supported context type
	public static String CONTEXT_TYPE = "org.ambientdynamix.contextplugins.plugin2";
	 ...
	 */
	public Plugin2Info(double number2) {
	 ...
	 */
	private Plugin2Info(final Parcel in) {
