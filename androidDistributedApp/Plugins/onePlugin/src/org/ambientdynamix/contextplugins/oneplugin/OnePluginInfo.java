...
class OnePluginInfo implements IContextInfo, IOnePluginInfo {
	/**
	 ...
	 */
	public static Parcelable.Creator<OnePluginInfo> CREATOR = new Parcelable.Creator<OnePluginInfo>() {
		/**
		 ...
		 */
		public OnePluginInfo createFromParcel(Parcel in) {
			return new OnePluginInfo(in);
		}

		/**
		 * Create a new array of the Parcelable class.
		 */
		public OnePluginInfo[] newArray(int size) {
			return new OnePluginInfo[size];
		}
	};
	// Public static variable for our supported context type
	public static String CONTEXT_TYPE = "org.ambientdynamix.contextplugins.oneplugin";
	 ...
	 */
	public OnePluginInfo(double counter) {
	 ...
	 */
	private OnePluginInfo(final Parcel in) {
