...
class GpsPluginInfo implements IContextInfo, IGpsPluginInfo {
	/**
	 ...
	 */
	public static Parcelable.Creator<GpsPluginInfo> CREATOR = new Parcelable.Creator<GpsPluginInfo>() {
		/**
		 ...
		 */
		public GpsPluginInfo createFromParcel(Parcel in) {
			return new GpsPluginInfo(in);
		}

		/**
		 * Create a new array of the Parcelable class.
		 */
		public GpsPluginInfo[] newArray(int size) {
			return new GpsPluginInfo[size];
		}
	};
	...
	public GpsPluginInfo(String position)
	{
	 ...
	 */
	private GpsPluginInfo(final Parcel in) {
