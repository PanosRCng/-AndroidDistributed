...
class WifiPluginInfo implements IContextInfo, IWifiPluginInfo {
	/**
	 ...
	 */
	public static Parcelable.Creator<WifiPluginInfo> CREATOR = new Parcelable.Creator<WifiPluginInfo>() {
		/**
		 ...
		 */
		public WifiPluginInfo createFromParcel(Parcel in) {
			return new WifiPluginInfo(in);
		}

		/**
		 * Create a new array of the Parcelable class.
		 */
		public WifiPluginInfo[] newArray(int size) {
			return new WifiPluginInfo[size];
		}
	};
	// Public static variable for our supported context type
	public static String CONTEXT_TYPE = "org.ambientdynamix.contextplugins.WifiPlugin";
	...
	public WifiPluginInfo(String bssid) {
		this.bssid = bssid;
	}
	 ...
	 */
	private WifiPluginInfo(final Parcel in)
	{
