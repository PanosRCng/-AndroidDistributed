 ...
 * 
 * <p>
 * NanoHTTPD version 1.25, Copyright &copy; 2001,2005-2012 Jarno Elonen (elonen@iki.fi, http://iki.fi/elonen/) and
...
public class NanoHTTPD {
	 ...
	 */
	Response serve(Socket socket, String uri, String method, Properties header, Properties parms, Properties files) {
	...
	private class HTTPSession implements Runnable {
		...
		public void run() {
			try {
				//Log.i("Nano", "Request for: " + mySocket);
				...
				BufferedReader hin = new BufferedReader(new InputStreamReader(hbis), 8192);
				...
				BufferedReader in = new BufferedReader(new InputStreamReader(bin), 8192);
				...
				// Ok, now do the serve()
				Response r = serve(mySocket, uri, method, header, parms, files);
				if (r == null)
