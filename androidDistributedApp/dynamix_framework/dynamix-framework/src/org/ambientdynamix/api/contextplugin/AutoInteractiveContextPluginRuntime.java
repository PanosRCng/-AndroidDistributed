...
/**
 * Base class for AutoInteractiveContextPluginRuntime implementations, which combine the functionality of the
 * AutoContextPluginRuntime and InteractiveContextPluginRuntime for ContextPluginRuntimes wishing to provide both types of
 * functionality. An AutoInteractiveContextPluginRuntime must provide runtime behavior that matches both of the aforementioned
 ...
 */
public abstract class AutoInteractiveContextPluginRuntime extends InteractiveContextPluginRuntime {
